...
/// Test hashes expected from `Komihash.hash()` function
/// when initialized with test seeds and provided with test messages.
pub const HASHES = [SEEDS.len][MSGS.len]u64{
